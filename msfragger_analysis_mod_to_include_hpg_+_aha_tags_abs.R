...
postscript("Supp Fig S13B HPG tagged spectral counts vs riBAQ.ps")
ggplot(hpg, aes(meanriBAQ_unenriched, n_mod_hit_u_HPG)) +
  geom_point() +
  theme_minimal(base_size = 18) +
  labs(x = "Mean RiBAQ bulk", y = "HPG-tagged spectral counts")
dev.off()
